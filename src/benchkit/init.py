...
dependencies = [
  "benchkit @ git+https://github.com/dvoid-io/benchkit@v0.3.0",
]
...
Managed with [benchkit](https://github.com/dvoid-io/benchkit) (contract 0.3, see `bench.yaml`).
